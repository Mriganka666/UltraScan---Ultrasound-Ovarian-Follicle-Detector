...
from script2 import ImageProcessorScript2  # Ensure this is the updated script

class ImageProcessingApp:
    def __init__(self, master):
        self.master = master
        self.master.title("UltraScan Using Fuzzy-C-Means")
    ...
    def show_image_script2(self, resized_image, enhanced_image, gray_image, segmented_labels, edges_canny, cropped_image_canny, contours_canny, num_follicles_canny):
        ...
        ax_contours_canny.set_title(f'Follicle Detection', color='black')
